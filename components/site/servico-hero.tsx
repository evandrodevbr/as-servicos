...
const TECH_SCOPE = [
 {
  title: 'Construir produtos digitais',
  text: 'Sites, sistemas, Next.js e arquitetura para produtos que evoluem.',
 },
 {
  title: 'Integrar software ao mundo real',
  text: 'APIs, automação, Tauri + Rust e hardware + software + IoT.',
 },
 {
     ...
     <Reveal delay={160} className="tech-scope mt-8 max-w-2xl">
      <div className="tech-scope__head">
       ...
       <p className="tech-scope__subtitle">
        Do produto digital à infraestrutura conectada, tudo precisa
